...
import { Loading, OverlayLoading } from "../Loading";
import { CancelButton, CloseButton, SaveButton, UpdateButton } from "../Button";
...
export default function FormDialog({
  ...
  return (
    <React.Fragment>
          ...
          {openLoading ? (
            ...
            <DialogContent style={{ padding: 0 }}>
              ...
              >
                ...
                >
                  {formType == "create" ? (
                    <SaveButton disabled={disabledSaveBtn} type="submit">
                      {" "}
                      {saveButtonText || "Save"}
                    </SaveButton>
                  ) : (
      ...
      <SnackbarMessage
        snackbar={snackbar}
        handleOnClose={handleOnCloseSnackbar}
      />
    </React.Fragment>
  );
}
